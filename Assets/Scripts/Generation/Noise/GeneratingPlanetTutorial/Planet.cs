...
//        if (waterMeshFilters == null || waterMeshFilters.Length == 0) waterMeshFilters = new MeshFilter[6];
...
//            terrainFaces[i] = new TerrainFace(shapeGenerator, meshFilters[i].sharedMesh, waterMeshFilters[i].sharedMesh, resolution, directions[i]);
